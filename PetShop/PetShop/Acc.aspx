<%@ Page Title="" Language="C#" MasterPageFile="~/UserView.Master" AutoEventWireup="true" CodeBehind="Acc.aspx.cs" Inherits="PetShop.Acc" %>
            ...
            <td class="style4" colspan="2">
                <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
                    ...
                    <ItemTemplate>
                        ...
                        <br />
                        Name:
                        <asp:Label ID="BreedLabel" runat="server"  Text='<%# Eval("Name") %>' />
                        <br />
                       Cost:
                        <asp:Label ID="AgeLabel" runat="server" ForeColor="Red" Text='<%# Eval("Cost") %>' />
                        <br />
                        Description:
                        ...
                        <asp:ImageButton ID="ImageButton2" runat="server" Height="49px" 
                            ImageUrl="~/images/buyNowBig.jpg" onclick="ImageButton2_Click" Width="95px" PostBackUrl='<%# String.Format("Buy1.aspx?Name={0}&Cost={1}",Eval("Name"),Eval("Cost")) %>' />
                        <br />
                    </ItemTemplate>
                </asp:DataList>
            </td>
         ...
         <tr>
            <td colspan="2" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [tbl_Accessory] WHERE (([Category] = @Category) )">
                    <SelectParameters>
